...
The self-collision smoke test (`testscenes/collisiondetectiontests/self_collision_vertex_triangle.py`)
...
The cross-model smoke test (`testscenes/collisiondetectiontests/cross_model_vertex_triangle.py`) is
