...
# at the 80k and 200k bench sizes, factor 2 (default) and factor 4 (for the
# parallelism-collapse comparison). Same metric set as run_profile_5way_wsl.sh.
