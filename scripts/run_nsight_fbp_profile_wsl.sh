...
export LD_LIBRARY_PATH="/usr/lib/wsl/lib:${SOFA_ROOT}/lib:${SOFA_PLUGIN_LIB_PATHS}${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
...
# --- Run 1: tri-tri FBP ---
run_scene "tri_tri_fbp" "${REPO_DIR}/testscenes/collisiondetectiontests/one_tissue_one_blade.py" \
...
run_scene "vt_self_collision" "${REPO_DIR}/testscenes/collisiondetectiontests/self_collision_vertex_triangle.py" \
    SOFA_USE_FEATURE_BASED_PROXIMITY=1 \
    SOFA_USE_VERTEX_TRIANGLE_PROXIMITY=1 \
    SOFA_PROXIMITY_READ_CONTACT_COUNTER=1

# --- Run 3: v-t cross-model ---
run_scene "vt_cross_model" "${REPO_DIR}/testscenes/collisiondetectiontests/cross_model_vertex_triangle.py" \
    SOFA_USE_FEATURE_BASED_PROXIMITY=1 \
    SOFA_USE_VERTEX_TRIANGLE_PROXIMITY=1 \
    SOFA_PROXIMITY_READ_CONTACT_COUNTER=1
