...
BENCHMARK_LOG_DIR = os.path.join(current_dir, "output", "benchmark_logs")
...
def createScene(root):
    ...
    # Match the GPU benchmark contact stack so only the tissue compute path changes.
    ...
    root.addObject(BenchmarkTimingController(
        name='CpuBenchmarkTiming',
        label='cpu_deterministic_fixed',
